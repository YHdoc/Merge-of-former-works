...
while NumberofWordsinLastLine <= W:
    ...
    PenaltyforLastLine = Penalty(W,WordsLength1,NumberofSpace1)
...
# NumberofSpace2,WordsLength2=0,0
# PenaltyListforFormerLines[0]=0
# PenaltyListforFormerLines[1]=Penalty(W,len(words[0]),0)
# for k in range(2,TotalLengthoftheSentence-i):
#     WordsLength2 += len(words[k-1])
    
#     if WordsLength2+NumberofSpace2 <= W:
#         PenaltyListforFormerLines[k] = min(PenaltyListforFormerLines[k-1],Penalty(W,WordsLength2,NumberofSpace2))
#         NumberofSpace2 += 1
#     else:
#         PenaltyListforTotalLines.append(PenaltyListforFormerLines[k])
#         NumberofSpace2,WordsLength2=0,0
...
while idx != Range:
    ...
    for i in range(Range-idx):
        ...
        if WordsLength < W: 
            ...
            # print(f"Penalty : {PartialPenalty}\nTotal Penalty : {TotalPenalty}")
            break
print(f"Total Penalty : {PenaltyforFormerLines+min(PenaltyListforLastLine)}")
